...
void protobuf_AssignDesc_message_2eproto() {
  ...
  static const int filerange_offsets_[6] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(filerange, segno_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(filerange, offset_),
  ...
  static const int filelocation_offsets_[5] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(filelocation, segno_),
  ...
  filelocation_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(filelocation));
  msgcontainer_descriptor_ = file->message_type(4);
  static const int msgcontainer_offsets_[5] = {
...
void protobuf_AddDesc_message_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\005\022\013\n\003eip\030\004 \001(\t\022\r\n\005eport\030\005 \001(\005\"m\n\tfileran"
    "ge\022\014\n\004file\030\001 \002(\t\022\016\n\006fileID\030\002 \002(\005\022\r\n\005segn"
    "o\030\003 \002(\005\022\016\n\006offset\030\004 \002(\005\022\016\n\006length\030\005 \002(\005\022"
    "\023\n\013isMsgFromCL\030\006 \002(\010\"Q\n\014filelocation\022\r\n\005"
    "segno\030\001 \002(\005\022\014\n\004file\030\002 \001(\t\022\n\n\002ip\030\003 \001(\t\022\014\n"
    "\004port\030\004 \001(\005\022\n\n\002fd\030\005 \001(\005\"\227\002\n\014msgcontainer"
    "\022#\n\007msgtype\030\001 \002(\0162\022.msgcontainer.type\022\032\n"
    "\006frange\030\002 \001(\0132\n.filerange\022\033\n\004floc\030\003 \001(\0132"
    "\r.filelocation\022&\n\tdregister\030\004 \001(\0132\023.data"
    "serverregister\022\036\n\005dinfo\030\005 \001(\0132\017.dataserv"
    "erinfo\"a\n\004type\022\020\n\014FILELOCATION\020\000\022\014\n\010FILE"
    "READ\020\001\022\r\n\tFILEWRITE\020\002\022\026\n\022DATASERVERREGIS"
    "TER\020\003\022\022\n\016DATASERVERINFO\020\004", 625);
...
const int filerange::kSegnoFieldNumber;
const int filerange::kOffsetFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_segno;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_isMsgFromCL;
        break;
      }
...
void filerange::SerializeWithCachedSizes(
  ...
  // required int32 segno = 3;
  if (has_segno()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(3, this->segno(), output);
  }
  ...
  // required bool isMsgFromCL = 6;
  if (has_ismsgfromcl()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(6, this->ismsgfromcl(), output);
  }
...
::google::protobuf::uint8* filerange::SerializeWithCachedSizesToArray(
  ...
  // required int32 segno = 3;
  if (has_segno()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(3, this->segno(), target);
  }
  ...
  // required bool isMsgFromCL = 6;
  if (has_ismsgfromcl()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(6, this->ismsgfromcl(), target);
  }
...
#ifndef _MSC_VER
const int filelocation::kSegnoFieldNumber;
...
void filelocation::SerializeWithCachedSizes(
  ...
  // required int32 segno = 1;
  if (has_segno()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(1, this->segno(), output);
  }
...
::google::protobuf::uint8* filelocation::SerializeWithCachedSizesToArray(
  ...
  // required int32 segno = 1;
  if (has_segno()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(1, this->segno(), target);
  }
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_dregister;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(42)) goto parse_dinfo;
        break;
      }
...
bool msgcontainer::IsInitialized() const {
  ...
  if (has_floc()) {
    if (!this->floc().IsInitialized()) return false;
  }
  if (has_dregister()) {
